/*******************************************************************************
  ...
  Summary:
    This file contains the source code for the MPLAB Harmony CDC application.

  Description:
    This file contains the source code for the MPLAB Harmony CDC application.  It
    ...
    )
    {
        switch(event)
        {
            case USB_DEVICE_CDC_EVENT_SET_LINE_CODING:
                ...
                USB_DEVICE_ControlReceive(appData.usbDevHandle, &lineCoding, sizeof(lineCoding));
            ...
            case USB_DEVICE_CDC_EVENT_GET_LINE_CODING:
                ...
                USB_DEVICE_ControlSend(appData.usbDevHandle, &lineCoding, sizeof(lineCoding));
    ...
    switch ( cdcData.state )
    {
        ...
        case CDC_STATE_INIT:
        {
            if (appData.deviceIsConfigured)
            {
                ...
                USB_DEVICE_CDC_Read(USB_DEVICE_CDC_INDEX_0, &cdcData.rdTransferHandle,
                                    receiveDataBuffer, sizeof(receiveDataBuffer));
        ...
        case CDC_STATE_SERVICE_TASKS:
        {
            ...
            if (cdcData.cdcReadCompleted)
            {
                ...
                USB_DEVICE_CDC_Write(USB_DEVICE_CDC_INDEX_0, &cdcData.wrTransferHandle,
                                     receiveDataBuffer, 1, USB_DEVICE_CDC_TRANSFER_FLAGS_DATA_COMPLETE);
            ...
            if (cdcData.btnPressed)
            {
                ...
                {
                    USB_DEVICE_CDC_Write(USB_DEVICE_CDC_INDEX_0, &cdcData.wrTransferHandle,
                                         switchPrompt, sizeof(switchPrompt), USB_DEVICE_CDC_TRANSFER_FLAGS_DATA_COMPLETE);
                    cdcData.cdcWriteCompleted = false;
                    cdcData.btnPressed = false;
                }
            }
